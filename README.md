[index.html.html](https://github.com/user-attachments/files/28675001/index.html.html)
<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
...
<meta name="description" content="2分鐘快速了解您的產後落髮程度，獲得個人化養髮計畫">
<style>
...
.header {
  ...
  border-bottom: 2px solid #c9a05c;
}
...
function showResult(){
  ...
  if(total<=5){
    ...
    ctaT='預防勝於治療';
    ctaD='現在掌握正確知識，避免進入嚴重落髮期。\n加入蘇老師 LINE，領取免費「產後養髮完整指南」。';
  } else if(total<=12){
    level='中度落髮期'; icon='⚠️'; color='#BA7517';
    sub='您已進入明顯落髮階段\n需要系統性介入才能有效改善，現在是黃金介入期';
    sgs=[{c:'sg-a',t:'立即檢視根因',d:'賀爾蒙、鐵蛋白、甲狀腺是中度落髮三大根因，建議可做賀爾蒙檢查'},
         {c:'sg-g',t:'頭皮環境調理',d:'健髮紓壓頭皮護理（90分）可深度改善頭皮循環，快速看到頭皮健康變化'},
    ...
    sgs=[{c:'sg-r',t:'EMS 養髮療程',d:'高階 EMS 養髮（120分）針對嚴重落髮提供最強效的頭皮復甦方案'},
         ...
         {c:'sg-g',t:'心理支持同樣重要',d:'嚴重落髮對自信影響深遠，蘇老師專業團隊陪您走過產後的每一天'}];
    ctaT='需要立即專業協助';
    ctaD='您的評估結果顯示需要專業整合介入。\n蘇老師提供 1:1 落髮評估，針對您制定個人化養髮計畫。';
  }
