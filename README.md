...
body{font-family:-apple-system,"Noto Sans TC","PingFang TC",sans-serif;background:#fafafa;min-height:100vh;display:flex;flex-direction:column;align-items:center;padding:0 0 48px;}
.header{width:100%;background:#f5e6b8;text-align:center;padding:24px 16px 20px;border-bottom:2px solid #c9a05c;}
.header-brand{font-size:11px;color:#7a5820;letter-spacing:.18em;margin-bottom:6px;}
.header-title{font-size:20px;font-weight:700;color:#1a1612;letter-spacing:2px;line-height:1.5;}
.header-title span{color:#a06010;}
.header-sub{font-size:12px;color:#6a4820;margin-top:8px;letter-spacing:.04em;}
.card{width:100%;max-width:520px;background:#fff;border-radius:0 0 16px 16px;box-shadow:0 4px 24px rgba(0,0,0,.08);overflow:hidden;margin:0 16px;}
...
.opt{display:flex;align-items:center;gap:12px;border:1.5px solid #ede8e0;border-radius:10px;padding:12px 14px;cursor:pointer;transition:all .15s;background:#faf8f5;-webkit-tap-highlight-color:transparent;user-select:none;}
.opt:hover{border-color:#c9a05c;background:#fdf6ec;}
.opt.selected{border-color:#c9a05c;background:#fdf0d8;}
.opt-circle{width:20px;height:20px;border-radius:50%;border:2px solid #d5c9b8;flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:all .15s;}
...
.btn-prev{font-size:14px;color:#a08060;background:none;border:1.5px solid #ede8e0;border-radius:10px;padding:13px 20px;cursor:pointer;font-family:inherit;transition:all .15s;white-space:nowrap;}
.btn-prev:hover{background:#faf8f5;}
.btn-next{flex:1;font-size:14px;font-weight:700;color:#fff;background:#c9a05c;border:none;border-radius:10px;padding:13px;cursor:pointer;font-family:inherit;transition:opacity .15s;letter-spacing:.04em;}
...
.cta-block{margin:20px 24px 0;background:#1a1612;border-radius:12px;padding:22px 20px;text-align:center;}
...
.cta-btn{display:inline-block;background:#c9a05c;color:#1a1612;font-size:14px;font-weight:700;padding:13px 32px;border-radius:8px;cursor:pointer;border:none;font-family:inherit;letter-spacing:.06em;text-decoration:none;transition:opacity .15s;}
.cta-btn:hover{opacity:.88;}
.restart-btn{display:block;text-align:center;font-size:12px;color:#a08060;cursor:pointer;margin:16px auto 28px;background:none;border:none;font-family:inherit;text-decoration:underline;text-underline-offset:3px;}
.footer{margin-top:24px;text-align:center;font-size:11px;color:#b0a090;letter-spacing:.06em;line-height:1.9;}
@media(max-width:400px){.suggest-grid{grid-template-columns:1fr;}.q-text{font-size:15px;}}
</style>
</head>
<body>
<div class="header">
  ...
  <div class="header-sub">2 分鐘了解您的落髮程度，獲得個人化養髮計畫</div>
</div>
<div class="card">
  <div id="quizSection">
    <div class="progress-wrap">
      <div class="progress-meta"><span id="stepLabel">第 1 題，共 8 題</span><span id="pctLabel">12%</span></div>
  ...
  <div class="result" id="resultSection">
    ...
    <div class="suggest-title">針對您的個人養髮建議</div>
...
<div class="footer">蘇老師產康中心 · <br>© 2026 版權所有</div>
<script>
var Qs=[
{num:'Q1',text:'您目前產後幾個月？',hint:'',opts:[{t:'產前（懷孕中）',s:0},{t:'產後 1 個月內',s:1},{t:'產後 2–4 個月',s:3},{t:'產後 5–8 個月',s:3},{t:'產後 9 個月以上',s:2}]},
{num:'Q2',text:'您目前每天的落髮量大概是？',hint:'洗頭或梳髮時觀察',opts:[{t:'50根以內（正常範圍）',s:0},{t:'50–100根（輕微增加）',s:1},{t:'100–200根（明顯增多）',s:2},{t:'200根以上（大量掉落）',s:3},{t:'不確定，但明顯比以前多',s:2}]},
{num:'Q3',text:'落髮持續了多久了？',hint:'',opts:[{t:'剛開始（1–2週）',s:1},{t:'1–2 個月',s:2},{t:'3–6 個月',s:3},{t:'超過 6 個月',s:4},{t:'還沒開始但很擔心',s:0}]},
{num:'Q4',text:'頭髮有明顯變稀疏或頭皮更容易看見嗎？',hint:'特別是髮際線、分縫處',opts:[{t:'沒有，髮量看起來正常',s:0},{t:'稍微感覺髮量減少',s:1},{t:'明顯變稀，分縫變寬',s:3},{t:'非常明顯，影響到日常信心',s:4}]},
{num:'Q5',text:'您目前是否有以下任一情況？',hint:'選最符合的一項',opts:[{t:'仍在哺乳中',s:2},{t:'睡眠嚴重不足（每天少於 5 小時）',s:2},{t:'情緒壓力大或有產後憂鬱傾向',s:2},{t:'飲食不均衡或節食減重',s:2},{t:'以上皆無',s:0}]},
{num:'Q6',text:'您曾做過哪些應對措施？',hint:'',opts:[{t:'換了洗髮精或用生髮液',s:1},{t:'自行補充生物素或其他保健品',s:1},{t:'諮詢過醫師或做過檢查',s:0},{t:'什麼都還沒做，不知道從何開始',s:2},{t:'試過很多方法但效果不明顯',s:3}]},
{num:'Q7',text:'您的頭皮狀況如何？',hint:'',opts:[{t:'頭皮正常，無不適',s:0},{t:'偶爾會癢或出油',s:1},{t:'常常頭皮癢、敏感或有屑',s:2},{t:'頭皮緊繃、循環感覺很差',s:3}]},
{num:'Q8',text:'產後落髮對您的心情影響程度是？',hint:'',opts:[{t:'幾乎沒影響，只是注意到而已',s:0},{t:'有一點困擾，但還好',s:1},{t:'頗困擾，影響到自信心',s:2},{t:'非常困擾，每天都在擔心',s:3}]}
];
...
function render(){
  ...
  q.opts.forEach(function(o,i){
    ...
    html+='<div class="opt'+s+'" onclick="pick('+i+','+o.s+')">'+'<div class="opt-circle"><div class="opt-dot"></div></div>'+'<div class="opt-text">'+o.t+'</div></div>';
  });
...
function showResult(){
  ...
  if(total<=5){
    ...
    sgs=[{c:'sg-r',t:'EMS 養髮療程',d:'高階 EMS 養髮（120分）針對嚴重落髮提供最強效的頭皮復甦方案'},
         {c:'sg-a',t:'賀爾蒙整合評估',d:'嚴重落髮往往多重因素疊加，需全面評估雌激素、甲狀腺、鐵蛋白'},
         {c:'sg-p',t:'內外同步調理',d:'外部頭皮護理搭配內部營養補充與賀爾蒙調節，雙管齊下才能逆轉'},
         {c:'sg-g',t:'心理支持同樣重要',d:'嚴重落髮對自信影響深遠，蘇老師社群有許多走過相同歷程的媽媽支持您'}];
    ctaT='需要立即專業協助';
    ctaD='您的評估結果顯示需要專業整合介入。\n蘇老師提供 1:1 落髮評估，為您制定個人化養髮計畫。';
  }
